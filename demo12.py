...
if __name__ == '__main__':
    ...
    brf_daily = bt.feeds.PandasData(dataname=data0, fromdate=datetime.datetime(2020, 9, 16),
    ...
    returns.to_hdf('return.h5', key='data')#保存成h5格式，用jupyter notebook打开，返回两列的dataframe，【日期，每日return】 
